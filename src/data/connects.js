...
export const CONNECTS = [
  ...
  },
  {
    ...
    heatSpike: 6,
    flavour:
      "D-Nice keeps the best prices in Brooklyn — when he actually shows.",
  },
  {
    id: "jin",
    name: "Jin",
    ...
    heatSpike: 9,
    flavour:
      "Jin runs a tight operation out of Queens. Cash. Up front. Always.",
  },
  {
    id: "claudette",
    name: "Claudette",
  ...
  },
  {
    ...
    tiers: [
      { repRequired: 0, lotOz: 10, discount: 0.2, badDealChance: 0.08 },
      { repRequired: 15, lotOz: 25, discount: 0.3, badDealChance: 0.04 },
      { repRequired: 35, lotOz: 50, discount: 0.4, badDealChance: 0.01 },
      { repRequired: 60, lotOz: 100, discount: 0.5, badDealChance: 0.0 },
    ],
    qualityMin: 60,
    qualityMax: 85,
    unlock: "favour",
  ...
  },
  {
    ...
    qualityMax: 90,
    unlock: "rep:10",
    noShowChance: 0.3, // most unreliable
    heatSpike: 5,
    flavour:
      "Manny is always looking over his shoulder. Half the time he ghosts.",
  },
  {
    id: "lilray",
    name: "Lil Ray",
    ...
    tiers: [
      { repRequired: 0, lotOz: 10, discount: 0.18, badDealChance: 0.1 },
    ...
    flavour:
      "Lil Ray has plenty of product. So do the cops, who watch him 24/7.",
  },
  {
    id: "theswede",
    name: "The Swede",
    ...
    tiers: [
      { repRequired: 0, lotOz: 10, discount: 0.15, badDealChance: 0.05 },
      { repRequired: 15, lotOz: 25, discount: 0.25, badDealChance: 0.02 },
      { repRequired: 35, lotOz: 50, discount: 0.35, badDealChance: 0.0 },
      { repRequired: 60, lotOz: 100, discount: 0.45, badDealChance: 0.0 },
    ],
    qualityMin: 90,
    qualityMax: 100,
    ...
    heatSpike: 7,
    flavour:
      "The Swede moves the purest product in Jersey. Never cheap, never cut.",
  },
];
